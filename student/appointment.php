      ...
      <div class="container-fluid">
      	<div class="col-md-12">
      		<div class="row">
                ...
                $sel=mysqli_query($connect,"SELECT * FROM student WHERE username='$stu'");
                ...
                if(isset($_POST['book'])) {
                 ...
                 if(empty($sym)) {
                  ...
                  $query = "INSERT INTO appointment(student_name,reg_num,gender,phone,appointment_date,symptoms,date_booked) VALUES('$student_name','$reg_num','$gender','$phone','$date','$sym',NOW())";
