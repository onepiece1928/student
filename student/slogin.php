...
if (isset($_POST['login'])) {
	...
	$q = "SELECT * FROM student WHERE username='$uname' AND password='$password'";
	...
	if(count($error)==0){
		...
		$query="SELECT * FROM student WHERE username='$uname' AND password='$password'";
		...
		<div class="col-md-12">
			<div class="row">
				...
				<div class="col-md-6 jumbotron my-3">
					<h5 class="text-center my-2">Student login</h5>
