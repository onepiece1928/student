                                        ...
                                        <?php    
                                            ...
                                            if(isset($_POST['uname'])){
                                                ...
                                                if(empty($uname)){
                                                    ...
                                                    $query= "UPDATE student SET username='$uname' WHERE username='$stu'";
                                ...
                                <div class="col-md-6 my-4">
                                    <?php
                                        ...
                                        if(isset($_POST['update_pass'])){
                                            ...
                                            $old= mysqli_query($connect,"SELECT * FROM student WHERE username='$stu'");
                                            ...
                                            if(count($error)==0){
                                                ...
                                                $query="UPDATE student SET password='$new_pass' WHERE username='$stu'";
